...
- `POST /product-images/batch/delete` - Delete multiple product images in a batch.
- `POST /product-images/batch/product` - Get product images by multiple product IDs.
...
- `PUT /attributes/values/:id` - Update an attribute value.
...
- `PATCH /stores/:id` - Update a store's information.
...
- `PATCH /warehouses/:id` - Update a warehouse's information.
